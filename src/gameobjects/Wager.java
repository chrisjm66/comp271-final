...
public class Wager extends VBox {
	...
	private void createButtonListeners() {
		...
		// Assignment 3.2 Create listener for btnSubtract
		btnSubtract.setOnAction(e -> changeWager(changeAmount * -1));
	...
	// EC6
	public void setWagerEditable(boolean bool) {
		btnAdd.setDisable(!bool);
		btnSubtract.setDisable(!bool);
	}
}
